...
const query_score_dto_1 = require("../dto/query-score.dto");
...
let ScoresController = class ScoresController {
    ...
    async importScores(semesterId, file) {
        if (!file) {
            throw new common_1.BadRequestException('Vui lòng tải lên file Excel');
        }
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('VIEW_BONUS'),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [query_score_dto_1.QueryScoreDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [query_score_dto_1.QueryScoreDto, Object]),
    __metadata("design:returntype", Promise)
], ScoresController.prototype, "findMy", null);
__decorate([
